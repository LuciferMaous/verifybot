...
async def on_ready():
    ...
    if channel:
        ...
        embed.set_thumbnail(url="https://img.upanh.tv/2025/04/05/lol.png")
        embed.set_image(url="https://img.upanh.tv/2025/04/05/2025-02-16_20.png")

        # Footer chuyên nghiệp hơn
        embed.set_footer(
            text="Maous Store • 2025",
            icon_url="https://img.upanh.tv/2025/04/05/lol.png"
        )
